    ...
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            #or framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup4'].iloc[-1])):
                ...
                if option2 == 'breakout':
                   if (frame['Decision Super'].iloc[-h1]=='Buy' or frame['Decision Super2'].iloc[-h1]=='Buy' or frame['Decision Super3'].iloc[-h1]=='Buy'\
                   ...
                   and frame['Close'].iloc[-h1]>frame['sup6'].iloc[-h1] and frameh['Close'].iloc[-h1]>frameh['sup6'].iloc[-h1] \
            ...
            #(framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_EMA50'].iloc[-1]=='Sell'):
                ...
                if option2=='pullback':
                   ...
                   and (frame['Dec_EMA50'].iloc[-h1]=='Sell' or frame['Dec_EMA20'].iloc[-h1]=='Sell')\
                   and (frame['Dec_EMA200'].iloc[-h1]=='Sell' or frame['Close'].iloc[-1]<frame['sup6'].iloc[-1]):
