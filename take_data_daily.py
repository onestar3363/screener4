...
def get_figures(frame,r):
    ...
    fig.add_trace(go.Scatter(x=frame['Date'].tail(r), 
         ...
         name='Supertrend1'))
    fig.add_trace(go.Scatter(x=framew['Date'].tail(10), 
         y=framew['sup2'].tail(10),
         opacity=0.7,
         mode='markers', marker=dict(size=3,color='red'), 
         name='Supertrend1'))
    fig.add_trace(go.Scatter(x=framew['Date'].tail(10), 
         y=framew['sup4'].tail(10),
         opacity=0.7,
         mode='markers', marker=dict(size=3,color='red'), 
         name='Supertrend2'))
    fig.add_trace(go.Scatter(x=framew['Date'].tail(10), 
         y=framew['sup6'].tail(10),
         opacity=0.7,
         mode='markers', marker=dict(size=3,color='red'), 
         name='Supertrend3'))
    fig.add_trace(go.Scatter(x=frame['Date'].tail(r), 
...
for name, frame, frameh, framew in zip(names,framelist, framelisth, framelistw): 
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            if option1 == 'Buy' and (framew['Close'].iloc[-2]>framew['sup4'].iloc[-2] or framew['Close'].iloc[-2]>framew['sup6'].iloc[-2]):
            ...
            #or framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup4'].iloc[-1])):
                ...
                if option2 == 'breakout':
                   ...
                   #and (frame['Close'].iloc[-h1]>frame['sup6'].iloc[-h1] or frame['Close'].iloc[-h1]>frame['sup4'].iloc[-h1])\
                            ...
                            expander('breakout')
                if option2 == 'pullback':  
                   if (frame['Decision Super2'].iloc[-h1-1]=='Buy2' or frame['Decision Super2'].iloc[-h1-1]=='Buy2' or frame['Decision Super3'].iloc[-h1-1]=='Buy2'\
                   or frame['EMA50_cross'].iloc[-h1-1]=='Buy2' or frame['EMA50_cross'].iloc[-h1-1]=='Buy2' or frame['EMA200_cross'].iloc[-h1-1]=='Buy2'\
                   or frameh['Decision Super2'].iloc[-h1-1]=='Buy2' or frameh['Decision Super3'].iloc[-h1-1]=='Buy2'\
                   or frameh['EMA50_cross'].iloc[-h1-1]=='Buy2' or frameh['EMA50_cross'].iloc[-h1-1]=='Buy2')\
                ...
                if option2 == 'week': 
                   ...
                   #         sira +=1
                   #         expander('cosku')                          
            if option1 == 'Sell' and (framew['Close'].iloc[-2]<framew['sup4'].iloc[-2] or framew['Close'].iloc[-2]<framew['sup6'].iloc[-2]):
            #and (framew['Consolidating2'].iloc[-h1]=='Yes' and framew['Consolidating3'].iloc[-h1]=='Yes'):
            ...
            #(framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_EMA50'].iloc[-1]=='Sell'):
                ...
                if option2 == 'week':
                   ...
                   #and (framew['Dec_EMA50'].iloc[-2]=='Sell' or framew['Dec_EMA20'].iloc[-2]=='Sell')\
                            ...
                            expander('week pullback')
                if option2=='pullback':
                   if (frame['Decision Super2'].iloc[-h1]=='Sell2' or frame['Decision Super3'].iloc[-h1]=='Sell2'\
                   or frame['EMA50_cross'].iloc[-h1]=='Sell2' or frame['EMA20_cross'].iloc[-h1]=='Sell2')\
                   and (frame['Close'].iloc[-1]<frame['sup4'].iloc[-1] or frame['Close'].iloc[-1]<frame['sup6'].iloc[-1]):
